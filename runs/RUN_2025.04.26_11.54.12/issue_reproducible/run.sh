...
export CURRENT_NETLIST='./results/synthesis/lab1.v';
...
export FP_PDN_VOFFSET='2.500';
export FP_PDN_VPITCH='5.000';
...
export SAVE_DEF='./results/floorplan/lab1.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./results/floorplan/lab1.odb';
